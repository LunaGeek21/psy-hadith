...
function getQueryKeyInternal(path, input, type) {
	...
	if (type === "infinite" && isObject(input) && ("direction" in input || "cursor" in input)) {
		...
		return [splitPath, {
			input: _objectWithoutProperties(input, _excluded),
			type: "infinite"
		}];
	}
	return [splitPath, _objectSpread2(_objectSpread2({}, typeof input !== "undefined" && input !== skipToken && { input }), type && type !== "any" && { type })];
}
...
function getQueryKey(procedureOrRouter, ..._params) {
	...
	return getQueryKeyInternal(path, input, type !== null && type !== void 0 ? type : "any");
}
/**
...
//#endregion
export { _objectSpread2 as a, getQueryKeyInternal as i, getMutationKeyInternal as n, _objectWithoutProperties as o, getQueryKey as r, getMutationKey as t };

//# sourceMappingURL=getQueryKey-B1x5Ak4F.mjs.map