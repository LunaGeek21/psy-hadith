import { a as _objectSpread2, i as getQueryKeyInternal, n as getMutationKeyInternal } from "./getQueryKey-B1x5Ak4F.mjs";
...
function getClientArgs(queryKey, opts, infiniteParams) {
	...
	if (infiniteParams) {
		var _input;
		input = _objectSpread2(_objectSpread2(_objectSpread2({}, (_input = input) !== null && _input !== void 0 ? _input : {}), infiniteParams.pageParam ? { cursor: infiniteParams.pageParam } : {}), {}, { direction: infiniteParams.direction });
	}
	return [
		path.join("."),
		input,
	...
	return {
		infiniteQueryOptions: (path, queryKey, opts) => {
			...
			const queryFn = async (queryFnContext) => {
				var _opts$trpc;
				const actualOpts = _objectSpread2(_objectSpread2({}, opts), {}, { trpc: _objectSpread2(_objectSpread2({}, opts === null || opts === void 0 ? void 0 : opts.trpc), (opts === null || opts === void 0 || (_opts$trpc = opts.trpc) === null || _opts$trpc === void 0 ? void 0 : _opts$trpc.abortOnUnmount) ? { signal: queryFnContext.signal } : { signal: null }) });
				return await untypedClient.query(...getClientArgs(queryKey, actualOpts, {
					direction: queryFnContext.direction,
					pageParam: queryFnContext.pageParam
				}));
			};
			return Object.assign(infiniteQueryOptions(_objectSpread2(_objectSpread2({}, opts), {}, {
				initialData: opts === null || opts === void 0 ? void 0 : opts.initialData,
				queryKey,
				queryFn: inputIsSkipToken ? skipToken : queryFn,
				initialPageParam: (_ref = opts === null || opts === void 0 ? void 0 : opts.initialCursor) !== null && _ref !== void 0 ? _ref : null
		...
		queryOptions: (path, queryKey, opts) => {
			...
			const queryFn = async (queryFnContext) => {
				var _opts$trpc2;
				const actualOpts = _objectSpread2(_objectSpread2({}, opts), {}, { trpc: _objectSpread2(_objectSpread2({}, opts === null || opts === void 0 ? void 0 : opts.trpc), (opts === null || opts === void 0 || (_opts$trpc2 = opts.trpc) === null || _opts$trpc2 === void 0 ? void 0 : _opts$trpc2.abortOnUnmount) ? { signal: queryFnContext.signal } : { signal: null }) });
			...
			return Object.assign(queryOptions(_objectSpread2(_objectSpread2({}, opts), {}, {
				initialData: opts === null || opts === void 0 ? void 0 : opts.initialData,
				queryKey,
				queryFn: inputIsSkipToken ? skipToken : queryFn
			})), { trpc: createTRPCOptionsResult({ path }) });
		...
		fetchQuery: (queryKey, opts) => {
			return queryClient.fetchQuery(_objectSpread2(_objectSpread2({}, opts), {}, {
				queryKey,
		...
		fetchInfiniteQuery: (queryKey, opts) => {
			...
			return queryClient.fetchInfiniteQuery(_objectSpread2(_objectSpread2({}, opts), {}, {
				queryKey,
				...
				initialPageParam: (_opts$initialCursor = opts === null || opts === void 0 ? void 0 : opts.initialCursor) !== null && _opts$initialCursor !== void 0 ? _opts$initialCursor : null
			}));
		},
		prefetchQuery: (queryKey, opts) => {
			return queryClient.prefetchQuery(_objectSpread2(_objectSpread2({}, opts), {}, {
				queryKey,
				queryFn: () => untypedClient.query(...getClientArgs(queryKey, opts))
			}));
		},
		prefetchInfiniteQuery: (queryKey, opts) => {
			...
			return queryClient.prefetchInfiniteQuery(_objectSpread2(_objectSpread2({}, opts), {}, {
				queryKey,
				queryFn: ({ pageParam, direction }) => {
					return untypedClient.query(...getClientArgs(queryKey, opts, {
						pageParam,
				...
				initialPageParam: (_opts$initialCursor2 = opts === null || opts === void 0 ? void 0 : opts.initialCursor) !== null && _opts$initialCursor2 !== void 0 ? _opts$initialCursor2 : null
			}));
		},
		ensureQueryData: (queryKey, opts) => {
			return queryClient.ensureQueryData(_objectSpread2(_objectSpread2({}, opts), {}, {
				queryKey,
				queryFn: () => untypedClient.query(...getClientArgs(queryKey, opts))
			}));
		},
		invalidateQueries: (queryKey, filters, options) => {
			return queryClient.invalidateQueries(_objectSpread2(_objectSpread2({}, filters), {}, { queryKey }), options);
		},
		resetQueries: (queryKey, filters, options) => {
			return queryClient.resetQueries(_objectSpread2(_objectSpread2({}, filters), {}, { queryKey }), options);
		},
		refetchQueries: (queryKey, filters, options) => {
			return queryClient.refetchQueries(_objectSpread2(_objectSpread2({}, filters), {}, { queryKey }), options);
		},
		...
		setQueriesData: (queryKey, filters, updater, options) => {
			return queryClient.setQueriesData(_objectSpread2(_objectSpread2({}, filters), {}, { queryKey }), updater, options);
		},
		...
		isMutating: (filters) => {
			return queryClient.isMutating(_objectSpread2(_objectSpread2({}, filters), {}, { exact: true }));
		}
	};
}
//#endregion
...
function createRootHooks(config) {
	...
	const TRPCProvider = (props) => {
		...
		const contextValue = React.useMemo(() => _objectSpread2({
			abortOnUnmount,
			queryClient,
			client,
		...
		return /* @__PURE__ */ React.createElement(Context.Provider, { value: contextValue }, props.children);
	};
	function useContext() {
	...
	*/
	function useSSRQueryOptionsIfNeeded(queryKey, opts) {
		...
		return ssrState && ssrState !== "mounted" && ((_queryClient$getQuery = queryClient.getQueryCache().find({ queryKey })) === null || _queryClient$getQuery === void 0 ? void 0 : _queryClient$getQuery.state.status) === "error" ? _objectSpread2({ retryOnMount: false }, opts) : opts;
	}
	function useQuery$1(path, input, opts) {
		...
		const ssrOpts = useSSRQueryOptionsIfNeeded(queryKey, _objectSpread2(_objectSpread2({}, defaultOpts), opts));
		...
		const hook = useQuery(_objectSpread2(_objectSpread2({}, ssrOpts), {}, {
			queryKey,
			queryFn: isInputSkipToken ? input : async (queryFunctionContext) => {
				const actualOpts = _objectSpread2(_objectSpread2({}, ssrOpts), {}, { trpc: _objectSpread2(_objectSpread2({}, ssrOpts === null || ssrOpts === void 0 ? void 0 : ssrOpts.trpc), shouldAbortOnUnmount ? { signal: queryFunctionContext.signal } : { signal: null }) });
	...
	function usePrefetchQuery$1(path, input, opts) {
		...
		usePrefetchQuery(_objectSpread2(_objectSpread2({}, opts), {}, {
			queryKey,
			queryFn: isInputSkipToken ? input : (queryFunctionContext) => {
				const actualOpts = { trpc: _objectSpread2(_objectSpread2({}, opts === null || opts === void 0 ? void 0 : opts.trpc), shouldAbortOnUnmount ? { signal: queryFunctionContext.signal } : {}) };
	...
	function useSuspenseQuery$1(path, input, opts) {
		...
		const hook = useSuspenseQuery(_objectSpread2(_objectSpread2({}, opts), {}, {
			queryKey,
			queryFn: (queryFunctionContext) => {
				const actualOpts = _objectSpread2(_objectSpread2({}, opts), {}, { trpc: _objectSpread2(_objectSpread2({}, opts === null || opts === void 0 ? void 0 : opts.trpc), shouldAbortOnUnmount ? { signal: queryFunctionContext.signal } : { signal: null }) });
				return context.client.query(...getClientArgs(queryKey, actualOpts));
			}
		}), context.queryClient);
		hook.trpc = useHookResult({ path });
	...
	function useMutation$1(path, opts) {
		...
		const hook = useMutation(_objectSpread2(_objectSpread2({}, opts), {}, {
			mutationKey,
			mutationFn: (input) => {
	...
	function useSubscription(path, input, opts) {
		...
		const reset = React.useCallback(() => {
			...
			if (!enabled) {
				updateState(() => _objectSpread2(_objectSpread2({}, initialStateIdle), {}, { reset }));
				return;
			}
			updateState(() => _objectSpread2(_objectSpread2({}, initialStateConnecting), {}, { reset }));
			const subscription = client.subscription(path.join("."), input !== null && input !== void 0 ? input : void 0, {
				onStarted: () => {
					...
					updateState((prev) => _objectSpread2(_objectSpread2({}, prev), {}, {
						status: "pending",
						error: null
					}));
				},
				...
				onConnectionStateChange: (result) => {
					updateState((prev) => {
						switch (result.state) {
							case "idle": return _objectSpread2(_objectSpread2({}, prev), {}, {
								status: result.state,
								error: null,
								data: void 0
							});
							case "connecting": return _objectSpread2(_objectSpread2({}, prev), {}, {
								error: result.error,
								status: result.state
							});
		...
		const resultRef = React.useRef(enabled ? _objectSpread2(_objectSpread2({}, initialStateConnecting), {}, { reset }) : _objectSpread2(_objectSpread2({}, initialStateIdle), {}, { reset }));
	...
	function useInfiniteQuery$1(path, input, opts) {
		...
		const hook = useInfiniteQuery(_objectSpread2(_objectSpread2({}, ssrOpts), {}, {
	...
	function usePrefetchInfiniteQuery$1(path, input, opts) {
		...
		usePrefetchInfiniteQuery(_objectSpread2(_objectSpread2({}, opts), {}, {
			...
			queryFn: isInputSkipToken ? input : (queryFunctionContext) => {
				...
				const actualOpts = _objectSpread2(_objectSpread2({}, ssrOpts), {}, { trpc: _objectSpread2(_objectSpread2({}, ssrOpts === null || ssrOpts === void 0 ? void 0 : ssrOpts.trpc), shouldAbortOnUnmount ? { signal: queryFunctionContext.signal } : {}) });
				return context.client.query(...getClientArgs(queryKey, actualOpts, {
	...
	function useSuspenseInfiniteQuery$1(path, input, opts) {
		...
		const hook = useSuspenseInfiniteQuery(_objectSpread2(_objectSpread2({}, opts), {}, {
	...
	const useQueries$1 = (queriesCallback, options) => {
		...
		return useQueries({
			queries: queries.map((query) => _objectSpread2(_objectSpread2({}, query), {}, { queryKey: query.queryKey })),
	...
	const useSuspenseQueries$1 = (queriesCallback) => {
		...
		const queries = queriesCallback(createUseQueries(client));
		const hook = useSuspenseQueries({ queries: queries.map((query) => _objectSpread2(_objectSpread2({}, query), {}, {
...
//#endregion
export { createUseQueries as a, getQueryType as c, createReactDecoration as d, getClientArgs as i, TRPCContext as l, createRootHooks as n, createQueryUtilsProxy as o, createUtilityFunctions as r, createReactQueryUtils as s, getQueryClient as t, contextProps as u };

//# sourceMappingURL=shared-DhkLzxq7.mjs.map