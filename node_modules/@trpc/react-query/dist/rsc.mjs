import { a as _objectSpread2, i as getQueryKeyInternal } from "./getQueryKey-B1x5Ak4F.mjs";
...
function createHydrationHelpers(caller, getQueryClient) {
	const wrappedProxy = createRecursiveProxy(async (opts) => {
		...
		if (helper === "prefetch") {
			const args1 = args[1];
			return getQueryClient().prefetchQuery(_objectSpread2(_objectSpread2({}, args1), {}, {
		...
		if (helper === "prefetchInfinite") {
			...
			const args1 = args[1];
			return getQueryClient().prefetchInfiniteQuery(_objectSpread2(_objectSpread2({}, args1), {}, {
	...
	function HydrateClient(props) {
		...
		return /* @__PURE__ */ React.createElement(HydrationBoundary, { state: dehydratedState }, props.children);
	}
	return {
		/***
